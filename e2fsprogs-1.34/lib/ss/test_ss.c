 ...
 *------------------------------------------------------------------
 *
 * $Source: /home/cvsroot/NSLU2/user/e2fsprogs-1.34/lib/ss/test_ss.c,v $
 * $Revision: 1.1.1.1 $
 * $Date: 2004/03/24 19:54:23 $
 * $State: Exp $
 * $Author: sure $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.1.1.1  2004/03/24 19:54:23  sure
...
static char const rcsid_test_c[] =
    "$Header: /home/cvsroot/NSLU2/user/e2fsprogs-1.34/lib/ss/test_ss.c,v 1.1.1.1 2004/03/24 19:54:23 sure Exp $";
#endif /* lint */
